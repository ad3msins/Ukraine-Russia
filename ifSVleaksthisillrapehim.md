...
local colors = {
    SchemeColor = Color3.fromRGB(26, 10, 68),
    Background = Color3.fromRGB(75, 25, 210),
    Header = Color3.fromRGB(31, 14, 78),
    TextColor = Color3.fromRGB(225,225,225),
    ElementColor = Color3.fromRGB(10, 20, 20)
}
local Window = Library.CreateLib("Calamari SV", colors)
...
game.StarterGui:SetCore("SendNotification",  {
 Title = "Calamari SV Loaded!";
 Text = "Edition loaded, V.1.1 ~ STILL A WIP BTW";
 Icon = "";
 Duration = 5;
...
local Section = Tab:NewSection("Welcome to Calamari SV! ~ Version 1.0.1 ~")
Section:NewButton("Click to copy the discord!", "Discord Server", function()
	setclipboard("discord.gg/5hwS3QRDSY")
local function callback(Text)
    if Text == "Button1 text" then
     print ("Answer")
   elseif Text == ("Button2 text") then
   ...
   game.StarterGui:SetCore("SendNotification",  {
    Title = "Link Copied!";
    Text = "Link - discord.gg/5hwS3QRDSY";
    Icon = "";
    Duration = 5;
    Callback = NotificationBindable;
   })
end)
local Section = Tab:NewSection("Human Scripts!")
Section:NewButton("Speed (V)", "Walk Fast Cuh!", function()
    ...
    game.StarterGui:SetCore("SendNotification",{
                Title = "Calamari Unlocked Speed!";
                Text = "Run Lad!";
                Duration = 1;
            })
end)
Section:NewSlider("Inf Jump", "Inf Jump Height", 300, 50, function(s) -- 500 (MaxValue) | 0 (MinValue)
...
Section:NewButton("Anti Lock", " fast ", function()
	getgenv().Fix = false
	getgenv().TeclasWS = {
		["tecla1"] = "y", -- speed +5
		["tecla2"] = "u", -- speed -5
...
-- // conexión
	L_186_.KeyDown:Connect(function(L_200_arg0)
		if L_200_arg0:lower() == TeclasWS.tecla1:lower() then
			L_191_ = L_191_ + 5
			anunciar_atentado_terrorista("Speed (Your Speed is = " .. tostring(L_191_) .. ")")
		...
		elseif L_200_arg0:lower() == TeclasWS.tecla3:lower() then
			if L_192_ then
				L_192_ = false
				anunciar_atentado_terrorista("Fix Anti Lock Is Disabled")
			else
				L_192_ = true
				anunciar_atentado_terrorista("Fix Anti Lock Is Enabled")
			end
		end
	end)
...
Section:NewButton("Spinbot (C)", "Spin fast cuh!", function()
...
Section:NewButton("Fly", "insert dick", function()
...
local Section = Tab:NewSection("Gun Mods! ~ Version 1.0.1 ~")
local Section = Tab:NewSection("Misc! ~ Version 1.0.1 ~")
Section:NewButton("Chat Spy!", "See everyones messages!", function()
...
Section:NewSlider("Camera FOV", "Fov for your camera", 120, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game:GetService'Workspace'.Camera.FieldOfView = s
end)
Section:NewButton("Rejoin Server", "Rejoins the server you was just in!", function()
...
Section:NewButton("Force Reset", "die", function()
...
local Section = Tab:NewSection("Welcome to the Aiming Tab! ~ Version 1.0.1 ~")
Section:NewButton("Aimlock GUI (BETA)", "Aimlock These Kids lmfao.", function()
...
local L_4_ = L_3_.CreateLib("Calamari Aim Gui! ~ Version ~ 1.7", "Sentinel")
local L_5_ = L_4_:NewTab("Aim")
local L_6_ = L_5_:NewSection("Welcome to Calamari Aim Gui! ~ Version 1.7 ~")
L_6_:NewButton(
    "Click this for the discord server!",
    "Copies the discord server invite!",
    function()
    	setclipboard("discord.com/invite/eJx7eyz78p")
...
local L_8_ = L_7_:NewSection("Welcome to Calamari SV! ~ Version 1.0.1 ~")
L_8_:NewButton(
    "Silent Aim",
...
L_8_:NewTextBox(
    ...
    "Check the discord for the best settings! ps no discord yet",
    function(L_72_arg0)
...
local L_13_ = L_4_:NewTab("Random")
local L_14_ = L_13_:NewSection("Calamari W")
local L_14_ = L_13_:NewSection("bob marley#4938")
local L_14_ = L_13_:NewSection("HypnoGarf is my G!")
end)
local Section = Tab:NewSection("Silent Aim Is Fixed!")


-- esp
local Tab = Window:NewTab("Esp")
local Section = Tab:NewSection("Welcome to the Esp Tab! ~ Version 1.0.1 ~")
Section:NewButton("ESP (BETA)", "locate these idiots", function()
...
local Section = Tab:NewSection("Welcome to the Trash Talk Tab! ~ Version 1.0.1 ~")
Section:NewButton("Trash Talk (J)", "Shit on kids..", function()
...
Section:NewButton("Compliment someone. (N)", "Be nice!", function()
local plr = game.Players.LocalPlayer
repeat wait() until plr.Character
local char = plr.Character
...
-- client side
local Tab = Window:NewTab("Other CS!")
local Section = Tab:NewSection("Welcome to the Client Side Tab! ~ Version 1.0.1 ~")
Section:NewButton("Blizzard Beast Mode CS", "Client Sided!", function()
...
Section:NewButton("Super Super Happy Face CS", "Client Sided!", function()
...
Section:NewButton("Headless - Clientsided", "Free  headless!", function()
...
Section:NewButton("Korblox - Clientsided", "Free  korblox!", function()
...
local Section = Tab:NewSection("Welcome to the Credits Tab!! ~ Version 1.0.1 ~ ")
Section:NewDropdown("Credits", "Credits all in here!", {"Made by bob marley#4938", "Made with the power of scriptware", "Soft Vortex Is Ass."}, function(currentOption)
    print(currentOption)
end)
